...
pub const API_VERSION: (u32, u32) = (1u32, 16u32);
...
pub enum EspHomeMessage {
    ...
    DeviceCapabilitiesRequest(DeviceCapabilitiesRequest),
    DeviceCapabilitiesResponse(DeviceCapabilitiesResponse),
    ...
    ZWaveProxyRequestResponse(ZWaveProxyRequestResponse),
...
impl EspHomeMessage {
    ...
    const fn get_message_type(&self) -> u16 {
        match self {
            ...
            Self::DeviceCapabilitiesRequest(_) => 149u16,
            Self::DeviceCapabilitiesResponse(_) => 150u16,
            ...
            Self::ZWaveProxyRequestResponse(_) => 151u16,
...
impl From<EspHomeMessage> for Vec<u8> {
    ...
    fn from(val: EspHomeMessage) -> Self {
        ...
        let payload = match val {
            ...
            EspHomeMessage::DeviceCapabilitiesRequest(d) => d.encode_to_vec(),
            EspHomeMessage::DeviceCapabilitiesResponse(d) => d.encode_to_vec(),
            ...
            EspHomeMessage::ZWaveProxyRequestResponse(d) => d.encode_to_vec(),
...
impl TryFrom<Vec<u8>> for EspHomeMessage {
    ...
    fn try_from(msg: Vec<u8>) -> Result<Self, Self::Error> {
        ...
        match type_id {
            ...
            149u16 => {
                DeviceCapabilitiesRequest::decode(payload)
                    .map(EspHomeMessage::DeviceCapabilitiesRequest)
            }
            150u16 => {
                DeviceCapabilitiesResponse::decode(payload)
                    .map(EspHomeMessage::DeviceCapabilitiesResponse)
            }
            11u16 => {
            ...
            151u16 => {
                ZWaveProxyRequestResponse::decode(payload)
                    .map(EspHomeMessage::ZWaveProxyRequestResponse)
            }
            135u16 => {
...
impl From<DeviceCapabilitiesRequest> for EspHomeMessage {
    fn from(msg: DeviceCapabilitiesRequest) -> Self {
        Self::DeviceCapabilitiesRequest(msg)
    }
}
impl From<DeviceCapabilitiesResponse> for EspHomeMessage {
    fn from(msg: DeviceCapabilitiesResponse) -> Self {
        Self::DeviceCapabilitiesResponse(msg)
    }
}
...
impl From<ZWaveProxyRequestResponse> for EspHomeMessage {
    fn from(msg: ZWaveProxyRequestResponse) -> Self {
        Self::ZWaveProxyRequestResponse(msg)
    }
}
